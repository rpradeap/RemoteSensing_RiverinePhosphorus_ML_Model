...
train.1 <- Smote_train(train.1, features_2, 0.25, 30) 
train.4 <- Smote_train(train.4, features_2, 0.3, 20) 
train.2 <- undersample_filter(train.2, 0.2, 10, 0.25, 0.75) 
train.3 <- undersample_filter(train.3, 0.3, 30, 0.15, 0.85) 
train.5 <- undersample_filter(train.5, 0.3, 30, 0, 1)
